...
#ifndef proto_2fhello_2eproto_2epb_2eh
#define proto_2fhello_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:Numeric) */ {
 public:
  ...
  ~Numeric() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Numeric* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(Numeric));
  }
#endif
  ...
  Numeric* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // proto_2fhello_2eproto_2epb_2eh
