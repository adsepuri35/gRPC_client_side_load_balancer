...
inline void Numeric::SharedDtor(MessageLite& self) {
  Numeric& this_ = static_cast<Numeric&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
  this_._impl_.~Impl_();
}

inline void* Numeric::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
  return ::new (mem) Numeric(arena);
}
constexpr auto Numeric::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(Numeric),
                                            alignof(Numeric));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull Numeric::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        &_Numeric_default_instance_._instance,
        &_table_.header,
        nullptr,  // OnDemandRegisterArenaDtor
        nullptr,  // IsInitialized
        &Numeric::MergeImpl,
        ::google::protobuf::Message::GetNewImpl<Numeric>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Numeric::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Numeric>(), &Numeric::ByteSizeLong,
            &Numeric::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* Numeric::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
  return _class_data_.base();
}
...
// @@protoc_insertion_point(message_clear_start:Numeric)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Numeric::_InternalSerialize(
            const MessageLite& base, ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) {
          const Numeric& this_ = static_cast<const Numeric&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::uint8_t* Numeric::_InternalSerialize(
            ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) const {
          const Numeric& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::size_t Numeric::ByteSizeLong(const MessageLite& base) {
          const Numeric& this_ = static_cast<const Numeric&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
